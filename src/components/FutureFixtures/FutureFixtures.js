...
import styles from './FutureFixtures.module.css';

export class FutureFixtures extends React.Component {
  render() {
  ...
  componentDidMount() {
    fetch("http://localhost:8080/team/"+this.state.teamSelectedId+"/futurefixtures")
      .then(res => res.json())
      .then(
        (result) => {
          this.setState({
